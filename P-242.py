...
print("Number of blocks Present:  ",Number_of_blocks)

# Write Task 02 code from below
print('previous hash code of genesis block: ',blockchain.chain[0]['previous_hash'])
print('current hash code of genesis block: ',blockchain.chain[0]['Current_hash'])
print('previous hash code of first block: ',blockchain.chain[1]['previous_hash'])
